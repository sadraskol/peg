...
public class PropositionTest {
    ...
    class SplitConjunctiveNormalForm {
        ...
        void splitNestedConjunctions() {
            ...
            assertEquals(
                    List.of(new Proposition.Or(x, z), new Proposition.Or(x, w), new Proposition.Or(y, z), new Proposition.Or(y, w)),
                    new Proposition.And(
                            new Proposition.And(new Proposition.Or(x, z), new Proposition.Or(x, w)),
                            new Proposition.And(new Proposition.Or(y, z), new Proposition.Or(y, w))).splitConjonctiveNormalForm().toList());
        }
    }
}
