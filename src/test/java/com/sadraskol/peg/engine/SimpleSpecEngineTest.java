...
//
//        assertEquals(new QualifiedName(List.of("peg", "lang"), "String"), engine.resolve("String"));
//    }
//
//    @Test
...
//
//        assertEquals(List.of(new PegRecord("Room", List.of(new QualifiedName(List.of("peg", "lang"), "String"))),
//                new PegRecord("Teacher", List.of(new QualifiedName(List.of("peg", "lang"), "String")))), records);
//    }
...
//        engine.records();
//
//        assertEquals(Map.of("Room", new SetValue.Universe(), "Room#teacher", new SetValue.Universe(), "Teacher", new SetValue.Universe()), engine.sets());
//
//        engine.facts();
//
...
//        assertEquals(new SetValue.Set(List.of("Gerber", "Damasio")), engine.sets().get("Teacher"));
//    }
//
//    @Test
